...
#[tauri::command]
pub async fn detect_environment() -> Result<environment::EnvironmentStatus, String> {
...
#[tauri::command]
pub async fn check_path() -> Result<environment::PathCheck, String> {
...
#[tauri::command]
pub async fn refresh_environment() -> Result<crate::env_refresh::RefreshedPath, String> {
...
#[tauri::command]
pub async fn detect_node_detailed() -> Result<environment::NodeDetectionResult, String> {
